...
class StatsModel {
  ...
  factory StatsModel.fromJson(Map<String, dynamic> json) {
    return StatsModel(
      totalCobrado: json['totalCobrado'] ?? 0,
      totalDeuda: json['totalDeuda'] ?? 0,
      totalSaldoAFavor: json['totalSaldoAFavor'] ?? 0,
      cantidadLocales: json['cantidadLocales'] ?? 0,
      cantidadMercados: json['cantidadMercados'] ?? 0,
