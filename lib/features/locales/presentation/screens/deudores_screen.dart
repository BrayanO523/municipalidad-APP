  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (state.filtroDeuda != LocalFiltroDeuda.soloDeudores) {
        await notifier.cambiarFiltroDeuda(LocalFiltroDeuda.soloDeudores);
                                          ...
                                          return Center(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'No hay locales con deuda acumulada',
                                                  style: TextStyle(
...
class _DeudoresHeader extends ConsumerWidget {
...
class _DeudoresSearchInput extends StatelessWidget {
  final TextEditingController controller;
  final ValueChanged<String> onChanged;

  const _DeudoresSearchInput({
        ...
        rows: locales.map((l) {
          ...
          return DataRow(
            ...
            cells: [
              ...
              DataCell(
                _MoneyChip(
                  value: (l.deudaAcumulada ?? 0).toDouble(),
                  isPositive: false,
                ),
              ),
              DataCell(
